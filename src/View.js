...
export default function View(props) {
  ...
  <div>
      ...
      <button className="btn btn-danger mx-1" onClick={delItem} id={id}>delete</button>
    ...
    const delItem=(event)=>{
      fbase.child(`key/${event.target.id}`).remove()
    }
  ...
  return (
    ...
    <div>
      ...
      <Header search={collect} counter={props.count} show={props.show}/>
